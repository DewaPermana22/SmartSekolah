    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div
            ...
            <div class="px-6 py-4 border-b border-gray-200 dark:border-neutral-700 flex items-center">
                <a navigate href="{{ route('superadmin.subjects.index') }}"
            ...
            <form id="add-form" class="p-6" navigate-form action="{{ route('superadmin.subjects.create') }}"
                method="POST">
                @csrf
                ...
                <div class="space-y-4">
                    {{-- Name --}}
                    <div>
                        <label for="name" class="block text-sm font-medium mb-2 dark:text-white">Nama Mata Pelajaran <span
