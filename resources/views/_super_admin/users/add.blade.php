                    ...
                    <div class="space-y-2">
                        ...
                        <select name="access_type" id="access_type" onchange="toggleSchoolField()"
                            ...
                            @foreach (UserConst::getAccessTypes() as $key => $value)
                                <option value="{{ $key }}" {{ old('access_type') == $key ? 'selected' : '' }}>
                                    {{ $value }}
                                </option>
                            @endforeach
                        </select>
