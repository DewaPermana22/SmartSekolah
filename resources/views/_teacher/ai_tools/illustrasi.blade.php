    ...
    <div class="grid gap-3 md:flex md:justify-between md:items-center py-4">
        <div>
            ...
            <p class="text-md text-gray-400 dark:text-neutral-400">
                Buat ilustrasi edukatif dengan AI untuk materi pembelajaran
            </p>
        </div>
    </div>
                ...
                <div class="mb-6">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
                        <label class="cursor-pointer group relative">
                            <input type="radio" name="style" value="3d-cartoon" class="peer absolute z-10 top-2 left-2" checked>
                            <div
                                class="border-2 border-gray-200 rounded-lg overflow-hidden peer-checked:border-blue-500 peer-checked:ring-2 peer-checked:ring-blue-500 peer-checked:ring-offset-2 dark:border-neutral-700 dark:peer-checked:ring-offset-neutral-800 transition-all">
                                <div class="aspect-square bg-gradient-to-br from-purple-400 to-pink-600 relative">
                                    <img src="{{ asset('assets/image/ai/3d-kartun.png') }}"
                                        alt="3D Cartoon" class="w-full h-full object-cover">
                                    <div
                                        class="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent flex items-end p-2">
                                        <span class="text-white text-xs font-semibold">3D Kartun</span>
                                    </div>
                                </div>
                            </div>
                        </label>
                        ...
                        <label class="cursor-pointer group relative">
                            <input type="radio" name="style" value="watercolor" class="peer absolute z-10 top-2 left-2">
                            <div
                                class="border-2 border-gray-200 rounded-lg overflow-hidden peer-checked:border-blue-500 peer-checked:ring-2 peer-checked:ring-blue-500 peer-checked:ring-offset-2 dark:border-neutral-700 dark:peer-checked:ring-offset-neutral-800 transition-all">
                                <div class="aspect-square bg-gradient-to-br from-green-300 to-teal-500 relative">
                                    <img src="{{ asset('assets/image/ai/cat-air.png') }}"
                                        alt="Watercolor" class="w-full h-full object-cover">
                                    <div
                                        class="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent flex items-end p-2">
                                        <span class="text-white text-xs font-semibold">Cat Air</span>
                                    </div>
                                </div>
                            </div>
                        </label>
                        ...
                        <label class="cursor-pointer group relative">
                            <input type="radio" name="style" value="realistic" class="peer absolute z-10 top-2 left-2">
                            <div
                                class="border-2 border-gray-200 rounded-lg overflow-hidden peer-checked:border-blue-500 peer-checked:ring-2 peer-checked:ring-blue-500 peer-checked:ring-offset-2 dark:border-neutral-700 dark:peer-checked:ring-offset-neutral-800 transition-all">
                                <div class="aspect-square bg-gradient-to-br from-blue-400 to-blue-600 relative">
                                    <img src="{{ asset('assets/image/ai/realistis.png') }}"
                                        alt="Realistic" class="w-full h-full object-cover">
                                    <div
                                        class="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent flex items-end p-2">
                                        <span class="text-white text-xs font-semibold">Realistis</span>
                                    </div>
                                </div>
                            </div>
                        </label>
                        ...
                        <label class="cursor-pointer group relative">
                            <input type="radio" name="style" value="pencil-sketch" class="peer absolute z-10 top-2 left-2">
                            <div
                                class="border-2 border-gray-200 rounded-lg overflow-hidden peer-checked:border-blue-500 peer-checked:ring-2 peer-checked:ring-blue-500 peer-checked:ring-offset-2 dark:border-neutral-700 dark:peer-checked:ring-offset-neutral-800 transition-all">
                                <div class="aspect-square bg-gradient-to-br from-gray-300 to-gray-500 relative">
                                    <img src="{{ asset('assets/image/ai/sketsa-pensil.png') }}"
                                        alt="Pencil Sketch" class="w-full h-full object-cover">
                                    <div
                                        class="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent flex items-end p-2">
                                        <span class="text-white text-xs font-semibold">Sketsa Pensil</span>
                                    </div>
                                </div>
                            </div>
                        </label>
                        ...
                        <label class="cursor-pointer group relative">
                            <input type="radio" name="style" value="flat-vector" class="peer absolute z-10 top-2 left-2">
                            <div
                                class="border-2 border-gray-200 rounded-lg overflow-hidden peer-checked:border-blue-500 peer-checked:ring-2 peer-checked:ring-blue-500 peer-checked:ring-offset-2 dark:border-neutral-700 dark:peer-checked:ring-offset-neutral-800 transition-all">
                                <div class="aspect-square bg-gradient-to-br from-orange-400 to-red-500 relative">
                                    <img src="{{ asset('assets/image/ai/vektor-datar.png') }}"
                                        alt="Flat Vector" class="w-full h-full object-cover">
                                    <div
                                        class="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent flex items-end p-2">
                                        <span class="text-white text-xs font-semibold">Vektor Dasar</span>
                                    </div>
                                </div>
                            </div>
                        </label>
                        ...
                        <label class="cursor-pointer group relative">
                            <input type="radio" name="style" value="infographic" class="peer absolute z-10 top-2 left-2">
                            <div
                                class="border-2 border-gray-200 rounded-lg overflow-hidden peer-checked:border-blue-500 peer-checked:ring-2 peer-checked:ring-blue-500 peer-checked:ring-offset-2 dark:border-neutral-700 dark:peer-checked:ring-offset-neutral-800 transition-all">
                                <div class="aspect-square bg-gradient-to-br from-cyan-400 to-blue-600 relative">
                                    <img src="{{ asset('assets/image/ai/infografis.png') }}"
                                        alt="Infographic" class="w-full h-full object-cover">
                                    <div
                                        class="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent flex items-end p-2">
                                        <span class="text-white text-xs font-semibold">Infografis</span>
                                    </div>
                                </div>
                            </div>
                        </label>
