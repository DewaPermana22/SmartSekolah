...
@section('content')
    <div class="grid gap-3 md:flex md:justify-between md:items-center py-4">
        <x-page-title title="Data {{ $page['title'] }}"
                        ...
                        <div
                            ...
                            <div
                                ...
                                <div class="flex justify-between items-center py-4 px-5 border-b dark:border-neutral-700">
                                    ...
                                    <button type="button"
                                        class="size-8 inline-flex justify-center items-center rounded-lg border border-transparent text-gray-500 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 dark:text-neutral-400 dark:hover:bg-neutral-700 dark:focus:bg-neutral-700"
                                ...
                                <div class="p-5 text-center">
                                    ...
                                    <div>
                                        <p class="text-gray-600 dark:text-neutral-400">
                                            ...
                                            <span id="delete-item-name"
                                                class="font-semibold text-gray-900 dark:text-white"></span>?
                                        </p>
                                        <p class="mt-3 text-sm text-gray-500 dark:text-neutral-500">
                                            Tindakan ini <span class="text-red-600 dark:text-red-500 font-semibold">tidak
                                                dapat dibatalkan</span>.
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div
                                    ...
                                    <form id="delete-form" method="POST" class="inline">
                                        ...
                                        @method('DELETE')
                                        <button type="submit"
                                            class="py-2.5 px-4 inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-red-600 text-white hover:bg-red-700 focus:outline-none focus:bg-red-700">
                                            Ya, Hapus
                                        </button>
                                    </form>
                                </div>
