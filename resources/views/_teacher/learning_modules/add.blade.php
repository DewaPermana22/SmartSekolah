                    ...
                    <div>
                        ...
                        <div class="relative">
                            <select name="grade" id="grade"
                                ...
                                <option value="MI" {{ old('grade') == 'MI' ? 'selected' : '' }}>MI</option>
                                <option value="SMP" {{ old('grade') == 'SMP' ? 'selected' : '' }}>SMP</option>
                                <option value="MTS" {{ old('grade') == 'MTS' ? 'selected' : '' }}>MTS</option>
                                <option value="SMA" {{ old('grade') == 'SMA' ? 'selected' : '' }}>SMA</option>
                                <option value="SMK" {{ old('grade') == 'SMK' ? 'selected' : '' }}>SMK</option>
...
<script>
    $(document).ready(function() {
        ...
        // Trigger change on page load to populate class options if grade was already selected
        if ($('#grade').val()) {
