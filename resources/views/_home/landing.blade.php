...
<body class="bg-lightBg dark:bg-darkBg text-slate-800 dark:text-slate-100 transition-colors duration-300">
    ...
    <nav class="fixed w-full z-50 top-0 glass border-0 border-b border-slate-200 dark:border-slate-800">
        <div class="max-w-7xl mx-auto px-10 min-[1000px]:px-6 py-4 flex justify-between items-center">
            ...
            <div class="hidden min-[1000px]:flex items-center gap-8 text-sm font-medium">
                ...
                <a href="#gabung" class="bg-primary text-white px-6 py-2.5 rounded-full hover:bg-secondary transition-all shadow-lg shadow-indigo-500/20">Mulai Sekarang</a>
            </div>
    ...
    <div id="mobile-menu" class="glass">
        ...
        <div class="flex items-center gap-4 pt-4">
            ...
            <a href="#gabung" class="bg-primary text-white px-8 py-3 rounded-full">Mulai Sekarang</a>
        </div>
    </div>
        ...
        <div class="max-w-7xl mx-auto flex flex-col min-[1000px]:flex-row items-center justify-between gap-12">
            <div class="space-y-8 w-full min-[1000px]:w-[55%]">
                ...
                <div class="flex flex-col min-[500px]:flex-row gap-4">
                    <a class="bg-primary text-white justify-center text-sm min-[1090px]:text-base px-4 min-[1090px]:px-8 py-2 min-[1090px]:py-4 rounded-2xl font-bold hover:bg-secondary transition-all flex items-center gap-2">
        ...
        <div class="max-w-5xl mx-auto relative">
            <div class="bg-primary rounded-[3rem] px-8 py-16 md:p-20 text-center text-white relative z-10 overflow-hidden shadow-2xl">
                ...
                <div class="flex flex-col sm:flex-row justify-center gap-4">
                    <button class="bg-white text-primary px-10 py-4 rounded-2xl font-bold hover:bg-indigo-50 transition-all shadow-xl">
                        Daftarkan Sekolah Anda
                    </button>
                    <button class="bg-primary border-2 border-white/30 text-white px-10 py-4 rounded-2xl font-bold hover:bg-white/10 transition-all">
                        Hubungi Sales
                    </button>
                </div>
            </div>
    ...
    <footer class="py-16 bg-white dark:bg-slate-900 border-t border-slate-200 dark:border-slate-800 px-6">
        <div class="max-w-7xl mx-auto grid md:grid-cols-4 gap-12">
            <div class="space-y-6">
                ...
                <p class="text-slate-500 text-sm">Empowering the next generation with cutting-edge education technology. Built for Indonesia.</p>
                <div class="flex gap-4">
