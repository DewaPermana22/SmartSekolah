...
@section('content')
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div class="bg-white shadow-lg rounded-2xl dark:bg-neutral-800 border border-gray-100">
            ...
            <form class="p-6" navigate-form action="{{ route('admin.teachers.create') }}" method="POST">
                @csrf
                ...
                <div class="mt-4 flex gap-2">
                    <a navigate href="{{ route('admin.teachers.index') }}" class="px-3 py-2 border rounded-lg">Batal</a>
