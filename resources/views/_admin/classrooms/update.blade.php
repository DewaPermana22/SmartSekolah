            ...
            <form id="update-form" class="p-6" navigate-form
                ...
                <div class="mb-4">
                    <label for="entry_year" class="block text-sm font-medium mb-2 dark:text-white">Tahun Masuk <span
                            class="text-red-500">*</span></label>
                    <input type="text" id="entry_year" name="entry_year" value="{{ $data->entry_year ?? '' }}"
                        class="py-2.5 sm:py-3 px-4 block w-full border-gray-200 rounded-lg sm:text-sm focus:border-blue-500 focus:ring-blue-500 placeholder-neutral-300 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600 @error('entry_year') border-red-500 @enderror"
