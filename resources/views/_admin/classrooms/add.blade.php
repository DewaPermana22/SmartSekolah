...
@section('title', 'Tambah Kelas Sekolah')
...
@section('content')
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div
            ...
            <form id="add-form" class="p-6" navigate-form action="{{ route('admin.classrooms.create') }}"
                method="POST">
                @csrf
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        <label for="entry_year" class="block text-sm font-medium mb-2 dark:text-white">Tahun Masuk <span
                                class="text-red-500">*</span></label>
                        <input type="text" id="entry_year" name="entry_year" value="{{ old('entry_year') }}"
