...
@section('content')
    @if (Auth::user()->school_id)
        ...
        <!-- Preline is already bundled via npm in app.js -->
        ...
        <div class="max-w-4xl mx-auto mt-10">
            <div
                ...
                <div class="p-8 text-center">
                    <div
                        class="inline-flex justify-center items-center w-[62px] h-[62px] rounded-full border-4 border-blue-50 bg-blue-100 text-blue-600 mb-4 dark:border-neutral-700 dark:bg-blue-500/10 dark:text-blue-500">
                    ...
                    <p class="mt-2 text-gray-600 dark:text-neutral-400">
                        Langkah terakhir untuk memulai adalah mendaftarkan sekolah Anda. Setelah terdaftar, Anda akan dapat
                        mengakses semua fitur manajemen tugas dan data master.
                    </p>
                    <div class="mt-8">
                        <a class="py-3 px-6 inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 focus:outline-hidden focus:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none"
